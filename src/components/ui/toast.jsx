...
const Toast = React.forwardRef(({ className, variant, ...props }, ref) => {
  ...
  if (variant === "destructive") {
    ...
    baseClass += " border bg-background text-foreground";
  }
...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={
      ...
      "hover:bg-secondary focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 " +
      "group-[.destructive]:border-muted/40 hover:group-[.destructive]:border-destructive/30 hover:group-[.destructive]:bg-destructive " +
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={
      ...
      "focus:opacity-100 focus:outline-hidden focus:ring-2 group-hover:opacity-100 " +
