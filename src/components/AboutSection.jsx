        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-6">
                    <h3 className="text-2xl font-semibold">Passionate Web <span className="text-primary">Developer</span></h3>

                    <p className="text-sm text-gray-500">
                        I craft responsive and user-friendly web applications using React, Angular, and modern technologies
                    </p>

                    <p className="text-sm text-gray-500">Always curious, always building!</p>
                    ...
                    <div className="gradient-border p-6 card-hover">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-sm text-gray-500">Team player with a strong drive for continuous learning and applying new technologies</p>
                            </div>
